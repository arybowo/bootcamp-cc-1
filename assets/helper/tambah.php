	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(nama, npm, alamat) VALUES('$nama', '$npm', '$alamat')") or die(mysqli_error($koneksi));
				
				if($sql){
					echo '<script>alert("Yeay!! Berhasil menambahkan data. ^_^"); document.location="../../page/data.php";</script>';
				}else{
					echo '<div class="alert alert-warning">Gagal melakukan proses tambah data. !_!</div>';
				}
			}else{
				echo '<div class="alert alert-warning">Gagal, NAMA sudah terdaftar. -_-</div>';
			}
		}
		?>
