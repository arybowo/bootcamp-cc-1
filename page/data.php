		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="../assets/helper/tambah.php">Tambah</a>
					</li>
				</ul>
			</div>
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>'.$data['alamat'].'</td>
							<td>
								<a href="../assets/helper/edit.php?id='.$data['id'].'" class="badge badge-info">Edit</a>
								<a href="../assets/helper/delete.php?id='.$data['id'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						$no++;
